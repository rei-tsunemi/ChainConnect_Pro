...
export default function Navbar({darkToggle, setDarkToggle, principal}) {
        ...
        <div className="container px-4 mx-auto flex flex-wrap items-center justify-between">
          <div className="w-full relative flex justify-between lg:w-auto lg:static lg:block lg:justify-start">
            <a
              ...
              href="?canisterId=by6od-j4aaa-aaaaa-qaadq-cai"
            >
          ...
          >
            <ul className="flex flex-col lg:flex-row list-none lg:ml-auto">
              ...
              <li className="nav-item">
                <a
                  className="px-3 py-2 flex items-center text-sm font-light leading-snug hover:opacity-75"
                  href="https://github.com/forceBullet/ChainConnectPro"
                >
