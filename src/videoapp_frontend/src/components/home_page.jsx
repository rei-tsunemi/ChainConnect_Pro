    ...
    return(
        <div className="px-2">
            <div className="text-center text-md font-light mt-16">
                Start or Join a video meeting session
            </div>
            <div className="px-4">
                <div className="flex mx-4 flex-cols justify-center text-center text-sm font-light mt-16 text-white">
                    <button onClick={startSessionFunc} className={`rounded-sm shadow-md px-5 py-1 ${darkToggle == false ? "bg-gray-700 hover:bg-gray-600" : "bg-blue-300 hover:bg-blue-200 text-white"}text-white mx-4`}>
                        Start Session
                    </button>
                </div>
                ...
                <div className="flex flex-cols mx-4 justify-center text-center text-sm font-light mt-5">
                    ...
                    <button onClick={joinSessionFunc} className={`rounded-sm shadow-md px-5 py-1 ${darkToggle == false ? "bg-gray-700 hover:bg-gray-600" : "bg-blue-300 hover:bg-blue-200"}  text-white`}>
                        Join
                    </button>
                    {
                        joinError &&
